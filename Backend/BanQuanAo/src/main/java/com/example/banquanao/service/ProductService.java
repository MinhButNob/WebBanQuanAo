...
public class ProductService {
    ...
    public List<ProductDTO> getByCategory(Long categoryId) {
        List<Product> products = repo.findByCategoryIdAndStatus(categoryId, "ACTIVE");
    ...
    private ProductDTO toDTO(Product p) {
        return new ProductDTO(
                ...
                p.getName(),
                p.getPrice(),
                p.getSize() != null ? p.getSize().getId() : null,
                p.getSize() != null ? p.getSize().getSizeName() : null,
                p.getColor() != null ? p.getColor().getId() : null,
                p.getColor() != null ? p.getColor().getColorName() : null,
                p.getStock(),
                p.getImage(),
                p.getStatus(),
                p.getDescription(),
