  ...
  <div>
    ...
    <div class="d-flex gap-3 mb-4 flex-wrap justify-content-between">
      <div class="d-flex gap-3 flex-wrap">
        <select v-model="filterStatus" class="form-select w-auto" @change="resetPageAndFilter">
      ...
      <select v-model="pageSize" class="form-select w-auto" style="width: 120px" @change="currentPage = 1">
    ...
    <div v-else>
            ...
            <tr v-for="(order, index) in paginatedOrders" :key="order.id">
              ...
              <td>
                <button
                  ...
                  :disabled="saving === order.id"
                >
                  <span v-if="saving === order.id" class="spinner-border spinner-border-sm"></span>
      ...
      <!-- PHÂN TRANG -->
      <div v-if="filteredOrders.length > 0" class="d-flex justify-content-between align-items-center mt-3">
